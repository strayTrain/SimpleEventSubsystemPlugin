...
- Events are indentified by `EventTags` and categorized by `DomainTags` which are both simple [gameplay tags](https://www.tomlooman.com/unreal-engine-gameplaytags-data-driven-design/)
